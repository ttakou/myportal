  ...
  if (!(access.isHr || access.isSystemAdmin || access.isAdmin)) {
    return (
      <div className="mx-auto max-w-md space-y-4 py-16 text-center">
        ...
        <p className="text-muted-foreground">Performance reports are built by HR.</p>
    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-muted-foreground">
          Build reports from selectable dimensions and measures. Save, schedule, pin as widgets and
          control who can view them.
        </p>
      </div>
