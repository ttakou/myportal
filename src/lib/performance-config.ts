...
export function configFromRow(r: Record<string, unknown> | null | undefined): PerformanceConfig {
  ...
  return {
    ...
    minGoalWeight: num(r.min_goal_weight, DEFAULT_PERFORMANCE_CONFIG.minGoalWeight),
    maxGoalWeight: num(r.max_goal_weight, DEFAULT_PERFORMANCE_CONFIG.maxGoalWeight),
    ...
    allowModifyApproved: bool(r.allow_modify_approved, DEFAULT_PERFORMANCE_CONFIG.allowModifyApproved),
    changesRequireApproval: bool(r.changes_require_approval, DEFAULT_PERFORMANCE_CONFIG.changesRequireApproval),
    allowCarryForward: bool(r.allow_carry_forward, DEFAULT_PERFORMANCE_CONFIG.allowCarryForward),
    allowCascade: bool(r.allow_cascade, DEFAULT_PERFORMANCE_CONFIG.allowCascade),
