...
export const MODULE_PARAMS: Record<string, ModuleParamDef[]> = {
  visitors: [
    ...
    {
      key: "pass_expiry_notice_days",
      label: "Warn before a long-stay pass ends (days)",
      help: "The host and security hear this many days before a pass expires. 0 switches it off.",
      type: "number",
      default: 3,
      min: 0,
      max: 30,
    ...
    {
      key: "airport_place",
      label: "Airport, as the transport desk names it",
      help: "Pickup point of an arriving visitor's ride and drop-off of a departing one. Use the saved place's spelling.",
      type: "text",
      default: "Douala airport",
    },
    {
      key: "site_place",
      label: "Site entrance, as the transport desk names it",
      help: "Where an airport pickup ends and an airport drop-off starts.",
      type: "text",
      default: "Base main gate",
    },
    {
      key: "auto_no_show",
