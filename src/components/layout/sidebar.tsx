...
import { getApprovalAccess, getMyDriver, hasActiveShuttles } from "@/lib/transport";
...
export async function Sidebar({
  ...
  const [services, access, isManager, isTrainingAdmin, perms, isSavingsApprover, myDriver, approvalAccess, shuttlesOn] = await Promise.all([
    getActiveServices(),
    getAccess(),
    hasDirectReports(),
    getIsTrainingAdmin(),
